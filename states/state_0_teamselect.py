...
from consts import LIVE_TYPES, SOLO_LIVE, MULTI_LIVE, CHALLENGE_LIVE
...
class TeamSelect(State):
    ...
    def update(self, storage):
        ...
        live_type = utils.closest_match(utils.tess_en.get(live_type_img).lower(), LIVE_TYPES)
